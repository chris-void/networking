...
// Entity A
int txBase;
// first sequence number of window
int nextSeqNum;
// last sequence number within window
int nextMsg;
// message index
msg *msgBuffer;
// message buffer
...
// Statistics
int txPktCount;
// count of packets sent by A
int rxPktCount;
// count of packets received by B
int corruptPktCount;
// count of corrupted packets received by B
int rxmtCount;
// retransmit count
double *txPktTime;
// transmit time of each packet
double totalTtc;
// total time to communicate
int commPktCount;
// count of communicated packets
int receivedMsgCount;
// count of messages received by B
double *msgArriveTime;
// arrival times of each message
double totalDelay;
// total queuing delay
